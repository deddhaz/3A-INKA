      ...
      <main className="max-w-7xl mx-auto px-4">
        ...
        {activeTab === 'ranking' && (
          <div className="max-w-3xl mx-auto pb-24 animate-fade-in px-4">
             {/* --- HEADER PERINGKAT (DIPERBARUI) --- */}
             <div className="text-center mb-8 pt-4">
                <div className="bg-yellow-100 w-16 h-16 rounded-3xl flex items-center justify-center mx-auto mb-4 text-yellow-600 shadow-lg border-2 border-white transform -rotate-3">
                  <Trophy size={32} />
                </div>
                <h2 className="text-2xl md:text-3xl font-black text-gray-800 uppercase tracking-tight">Peringkat Kelas</h2>
                <p className="text-gray-500 font-bold text-xs uppercase tracking-widest mt-2">Ayo Semangat Kejar Prestasi!</p>
             </div>
